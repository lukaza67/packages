...
curl -s "https://api.github.com/repos/lynxnexy/luci-app-amlogic/releases" >${github_api_plugin} && sync
sleep 1
...
if [[ "${current_plugin_v}" == "${server_plugin_version}" ]]; then
    ...
    server_plugin_url="https://github.com/lynxnexy/luci-app-amlogic/releases/download"
